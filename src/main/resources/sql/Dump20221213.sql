...
CREATE TABLE `tbl_configuracion` (
  `V_COD_CONFIGURACION` varchar(4) NOT NULL,
  `V_RUC` varchar(11) NOT NULL,
  `V_NOMBRES_RAZON_SOCIAL` varchar(250) NOT NULL,
  `V_DIRECCION` varchar(250) NOT NULL,
  `N_IGV` decimal(2,2) NOT NULL,
  `N_ACTIVO` int NOT NULL,
  `V_COD_USU_REGISTRA` varchar(20) NOT NULL,
  `D_FEC_REGISTRO` datetime NOT NULL,
  `V_COD_USU_MODIFICA` varchar(20) DEFAULT NULL,
  `D_FEC_MODIFICACION` datetime DEFAULT NULL,
  PRIMARY KEY (`V_COD_CONFIGURACION`),
  UNIQUE KEY `V_COD_CONFIGURACION_UNIQUE` (`V_COD_CONFIGURACION`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tbl_serie` VALUES ('BE01',1,'TC02',1,'ADMIN','2022-12-13 00:00:00',NULL,NULL),('BE02',1,'TC02',1,'ADMIN','2022-12-13 00:00:00',NULL,NULL),('BE03',1,'TC02',1,'ADMIN','2022-12-13 00:00:00',NULL,NULL),('BE04',1,'TC02',1,'ADMIN','2022-12-13 00:00:00',NULL,NULL),('FE01',1,'TC01',1,'ADMIN','2022-12-13 00:00:00',NULL,NULL),('FE02',1,'TC01',1,'ADMIN','2022-12-13 00:00:00',NULL,NULL),('FE03',1,'TC01',1,'ADMIN','2022-12-13 00:00:00',NULL,NULL),('FE04',1,'TC01',1,'ADMIN','2022-12-13 00:00:00',NULL,NULL);
...
-- Dump completed on 2022-12-13 23:13:05
